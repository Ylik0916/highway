...
public class HwTownshipInformation extends BaseEntity
{
    ...
    /** 所属建制村数量 */
    private String numberOfIncorporatedVillages;
    ...
    public void setNumberOfIncorporatedVillages(String numberOfIncorporatedVillages) 
    {
        this.numberOfIncorporatedVillages = numberOfIncorporatedVillages;
    }

    public String getNumberOfIncorporatedVillages() 
    {
