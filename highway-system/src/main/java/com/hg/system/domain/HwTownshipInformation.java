...
/**
 * 乡镇信息对象 hw_township_information
 *
 * @author ruoyi
 * @date 2023-03-24
 */
public class HwTownshipInformation extends BaseEntity
{
    ...
    /** 岛屿是否建有陆岛交通码头 */
    @Excel(name = "岛屿是否建有陆岛交通码头")
    private String islandTransportationTerminal;

    /** 码头与陆地距离(公里) */
    @Excel(name = "码头与陆地距离(公里)")
    ...
    /** 乡镇政府高程（米） */
    @Excel(name = "乡镇政府高程", readConverterExp = "米=")
