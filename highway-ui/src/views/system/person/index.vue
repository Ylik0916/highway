<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="personList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属单位id" align="center" prop="personUnit" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="从业人员名称" prop="personName">
          <el-input v-model="form.personName" placeholder="请输入从业人员名称" />
        </el-form-item>
        <el-form-item label="所属单位id" prop="personUnit">
          <el-input v-model="form.personUnit" placeholder="请输入所属单位id" />
        </el-form-item>
        <el-form-item label="评价年度" prop="evaluateYears">
