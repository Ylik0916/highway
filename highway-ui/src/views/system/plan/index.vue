  ...
  <div class="bigBox">
    ...
    <div>
      <el-tabs v-model="activeName" type="card" style="width: 100%" @tab-click="handleClick" tab-position="top">
        <el-tab-pane label="年度计划" name="first"><year-plan></year-plan></el-tab-pane>
        <el-tab-pane label="明细上报" name="second"><detailed-reporting></detailed-reporting></el-tab-pane>
        <el-tab-pane label="明细审核" name="thirdly"><detailed-audit></detailed-audit></el-tab-pane>
      </el-tabs>
    </div>
...
import DetailedAudit from "@/views/system/detailedAudit";
import YearPlan from "@/views/system/yearPlan";
import DetailedReporting from "@/views/system/detailedReporting";

export default {
  name: "Plan",
  components:{DetailedAudit,YearPlan,DetailedReporting},
