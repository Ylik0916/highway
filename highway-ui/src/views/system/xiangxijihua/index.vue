<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="计划名称" prop="routeName">
        <el-input
      ...
      <el-form-item label="计划编码" prop="routeCoding">
        <el-input
      ...
      <el-form-item label="计划类型" prop="routeType">
        <el-select v-model="queryParams.routeType" placeholder="请选择计划类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="informationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="计划编码" align="center" prop="routeCoding" />
      <el-table-column label="计划名称" align="center" prop="routeName" />
      ...
      <el-table-column label="计划里程" align="center" prop="routeMileage" />
      <el-table-column label="计划类型" align="center" prop="routeType">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="计划名称" prop="routeName">
          <el-input v-model="form.routeName" placeholder="请输入计划名称" />
        </el-form-item>
        <el-form-item label="计划编码" prop="routeCoding">
          <el-input v-model="form.routeCoding" placeholder="请输入计划编码" />
        </el-form-item>
        ...
        <el-form-item label="计划里程" prop="routeMileage">
          <el-input v-model="form.routeMileage" placeholder="请输入计划里程" />
        </el-form-item>
        <el-form-item label="计划类型" prop="routeType">
          <el-select v-model="form.routeType" placeholder="请选择计划类型">
            <el-option
              v-for="dict in dict.type.route_type"
              :key="dict.value"
              :label="dict.label"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除计划列表编号为"' + ids + '"的数据项？').then(function() {
