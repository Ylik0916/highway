<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="delicacyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="路面类型id" align="center" prop="roadTypeid" />
      <el-table-column label="技术等级id" align="center" prop="technicalGradeid" />
      <el-table-column label="路面宽度" align="center" prop="roadWidth" />
